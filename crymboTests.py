...
paymentInit_API = "https://crymbo-integ.wallter.com/api/v2/payment/initiate"

# payment settle credentials
paymentSettle_API = "https://crymbo-integ.wallter.com/api/v2/payment/settle"
...
def main_flow_create():
    ...
    with requests.Session() as s:
        ...
        try:
            ...
            # crymbo_token = json.loads(crymboLogin_response.content)
        ...
        try:
            ...
            if (paymentInit_response.status_code in (200, 201, 202, 204)) and (paymentId is not None):
                ...
                try:
                    ...
                    # payment_identifier = paymentSettle_response.json().get("payment_identifier")
        ...
        try:
            getAccount_response = s.get(getAccount_API, headers={'Authorization': "Bearer " + crymbo_token},
                                        verify=False)
            accountBalance = getAccount_response.json().get("balance")  # should be taken from response
