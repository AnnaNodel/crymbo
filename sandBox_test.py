...
# create internal txn, complete it and verify that the fee is charged on the right beneficiary
...
mongo = MongoClient("transactions","mongodb://Wallter:Wallter2020@127.0.0.1:27017")
...
def main_flow():
    ...
    with requests.Session() as s:
        ...
        try:
            ...
            if response_redirect.status_code in (201, 202, 204, 200) and ref_id is not None:
